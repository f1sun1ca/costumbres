  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item active"><i class="fa fa-list mr-1"> </i>Nuevo Producto</li>
        </ol>
      </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="number" min="0" step="0.01" class="form-control" id="recipient-name" name="precio" required="">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
