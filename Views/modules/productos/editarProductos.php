...
<div class="container">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item active"><i class="fa fa-list mr-1"> </i> EDITAR PRODUCTOS </li>
  </ol>
  <form method="post">
    <?php foreach ($consulta as $key) : ?>
      ...
      <CENTER>
        <button type="submit" class="btn btn-primary" name="editarProductos">Editar producto</button>
      </CENTER>
      <br>
  </form>
<?php endforeach ?>
