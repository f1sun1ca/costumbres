...
<body>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="conta">
				<h1>Restaurante&nbsp;&nbsp;<i class="fa fa-cutlery">&nbsp;</i>&nbsp;Costumbres</h1>
				<form class="" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
					<hr>
					<div class="form-group">
						<i class="fa fa-user mr-1"></i> <label for="nombreusuario"><b> Nombre de Usuario</b></label>
						<input type="text" name="nombreusuario" class="form-control" placeholder="Nombre Usuario">
					</div>
					<div class="form-group">
						<i class="fa fa-unlock-alt mr-1"></i> <label for="password"><b> Contraseña</b></label>
